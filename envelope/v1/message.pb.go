...
var file_envelope_v1_message_proto_rawDesc = []byte{
	...
	0x79, 0x74, 0x65, 0x73, 0x22, 0xc1, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x14,
	0x0a, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x72,
	0x6f, 0x75, 0x74, 0x65, 0x12, 0x34, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20,
	...
	0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x6f,
	...
	0x74, 0x65, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x22, 0x91, 0x01, 0x0a, 0x0b, 0x50, 0x75, 0x62,
...
var file_envelope_v1_message_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_envelope_v1_message_proto_goTypes = []interface{}{
	...
	(*Publication)(nil),  // 3: edgehub.protocol.envelope.v1.Publication
	nil,                  // 4: edgehub.protocol.envelope.v1.Message.HeadersEntry
	(*shared.Error)(nil), // 5: edgehub.protocol.shared.Error
}
var file_envelope_v1_message_proto_depIdxs = []int32{
	4, // 0: edgehub.protocol.envelope.v1.Message.headers:type_name -> edgehub.protocol.envelope.v1.Message.HeadersEntry
	...
	3, // 3: edgehub.protocol.envelope.v1.Message.publication:type_name -> edgehub.protocol.envelope.v1.Publication
	5, // 4: edgehub.protocol.envelope.v1.Message.error:type_name -> edgehub.protocol.shared.Error
	5, // 5: edgehub.protocol.envelope.v1.Reply.error:type_name -> edgehub.protocol.shared.Error
